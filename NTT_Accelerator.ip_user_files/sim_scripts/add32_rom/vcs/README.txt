...
#
# Generated by export_simulation on Fri Jun 13 14:57:37 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './add32_rom.sh' script.

./add32_rom.sh -reset_run
...
./add32_rom.sh -noclean_files

For more information on the script, please type './add32_rom.sh -help'.
