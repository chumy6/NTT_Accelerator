...
#
# Generated by export_simulation on Fri Jun 13 16:36:42 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './add31_rom.sh' script.

./add31_rom.sh -reset_run
...
./add31_rom.sh -noclean_files

For more information on the script, please type './add31_rom.sh -help'.
