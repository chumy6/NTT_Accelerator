...
#
# Generated by export_simulation on Fri Jun 13 16:36:52 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './add7_rom.sh' script.

./add7_rom.sh -reset_run
...
./add7_rom.sh -noclean_files

For more information on the script, please type './add7_rom.sh -help'.
