...
HD_PWD='E:/Vivado_Project/NTT_Accelerator/NTT_Accelerator.runs/Mem0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mem0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mem0.tcl
