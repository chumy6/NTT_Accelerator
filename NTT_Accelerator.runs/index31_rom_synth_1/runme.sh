...
HD_PWD='E:/Vivado_Project/NTT_Accelerator/NTT_Accelerator.runs/index31_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log index31_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source index31_rom.tcl
