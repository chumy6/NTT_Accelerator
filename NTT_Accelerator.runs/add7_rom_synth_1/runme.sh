...
HD_PWD='E:/Vivado_Project/NTT_Accelerator/NTT_Accelerator.runs/add7_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add7_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add7_rom.tcl
