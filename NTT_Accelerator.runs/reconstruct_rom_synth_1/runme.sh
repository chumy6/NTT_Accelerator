...
HD_PWD='E:/Vivado_Project/NTT_Accelerator/NTT_Accelerator.runs/reconstruct_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reconstruct_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reconstruct_rom.tcl
