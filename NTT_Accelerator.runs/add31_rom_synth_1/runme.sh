...
HD_PWD='E:/Vivado_Project/NTT_Accelerator/NTT_Accelerator.runs/add31_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add31_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add31_rom.tcl
