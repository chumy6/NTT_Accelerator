...
HD_PWD='E:/Vivado_Project/NTT_Accelerator/NTT_Accelerator.runs/Twiddle_Factors_ROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Twiddle_Factors_ROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Twiddle_Factors_ROM.tcl
