...
HD_PWD='E:/Vivado_Project/NTT_Accelerator/NTT_Accelerator.runs/index32_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log index32_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source index32_rom.tcl
